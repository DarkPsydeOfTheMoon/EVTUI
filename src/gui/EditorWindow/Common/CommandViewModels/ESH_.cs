...
{
    public ESH_(DataManager config, CommandPointer cmd) : base(config, cmd)
    {
        ...
        this.WhenAnyValue(_ => _.ModelAssetID.Choice).Subscribe(_ => this.CommandData.ModelObjectId = this.ModelAssetID.Choice);
